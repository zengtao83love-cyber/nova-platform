package com.zov.smart.nova.system.api.vo.menu;
...
public class MenuTreeVO implements java.io.Serializable {
    ...
    private List<MenuTreeVO> children;
     ...
     public MenuTreeVO(){this.parentId=0L;this.sortOrder=0;this.visibleFlag=1;this.status="ENABLED";this.children=new ArrayList<MenuTreeVO>();} 
}
